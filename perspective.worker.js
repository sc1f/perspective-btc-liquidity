...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(Module) {
  ...
  function parse_expression_strings(expressions) {
    ...
    for (let expression_string of expressions) {
      ...
      if (alias_match !== null && alias_match !== void 0 && (_alias_match$groups = alias_match.groups) !== null && _alias_match$groups !== void 0 && _alias_match$groups.alias) {
      ...
      let parsed_expression_string = expression_string.replace(/([a-zA-Z_]+[a-zA-Z0-9_]*)/g, match => {
        if (match == "true") {
          return "True";
        } else if (match == "false") {
          return "False";
      ...
      const replace_interned_param = (match, _, intern_fn, value) => {
        ...
        return `${match.substring(0, intern_idx)}'${value}'${match.substring(intern_idx + intern_fn.length)}`;
      ...
      parsed_expression_string = parsed_expression_string.replace(/(replace_all|replace)\(.*?,\s*(intern\(\'(.*)\'\)),.*\)/g, replace_interned_param);
...
"use strict";
/*!******************************************************************************************************************!*\
  !*** ../../node_modules/source-map-loader/dist/cjs.js!../../packages/perspective/dist/esm/perspective.worker.js ***!
  \******************************************************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
